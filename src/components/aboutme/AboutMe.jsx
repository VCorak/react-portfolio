            ...
            <div className="right">
                <div className="wrapper">
                    ...
                    <p> Hello! My name is Valentina and I enjoy creating things that live on the internet. My interest in web development started back in 2015 when I
                        decided to try editing first Hello world page — turns out hacking together a custom divs and h1s taught me a lot about HTML & CSS!
                        <span> Fast-forward to today,</span> my path started in one online course where I wrote my first lines of code in JavaScript and React.
                        Realizing I have to learn more I jumped into BeCode bootcamp.
